...
var databaseUrl = "craftDB";
var collections = ["crafts"];

var db = mongojs(databaseUrl, collections);
db.on("error", function(error) {
  console.log("databasr Error: ", error);
});
...
app.get("/all/:id", function (req, res) {
  ...
  db.crafts.findOne({ _id: req.params.id
    })
...
app.post("/all/:id", function (req, res) {
  ...
  db.note.create(req.body)
    .then(function (dbNote) {
      ...
      return db.craftDB.findOneAndUpdate({
        _id: req.params.id
      }, {
        note: dbNote._id
      }, {
